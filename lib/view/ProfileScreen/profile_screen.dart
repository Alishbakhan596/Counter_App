...
import 'package:my_app/commons/custom_container.dart';
import 'package:my_app/view/ProfileScreen/EditProfile/edit_profile_screen.dart';
import 'package:my_app/view/ProfileScreen/settings_screen.dart';
import 'package:my_app/widgets/back_arrow.dart';

import 'SideMenu/side_menu_screen.dart'; // Import shared_preferences
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding:
              EdgeInsets.symmetric(vertical: height * 0.05, horizontal: 16.0),
          child: Column(
            children: [
              Row(
                children: [
